...
* for Ubuntu 22.04 DEB-packages `deb https://rw3tecnologia.jfrog.io/artifactory/xvia-debian-local focal-current main`
* for RHEL 8 packages `https://rw3tecnologia.jfrog.io/artifactory/xvia-release-rpm/rhel/8/current`.
